...
- 키: `'appData'`(lessons/students/rates/scores/corrects/wrong/hwRec/memos/attend/tabData/fileName/mascotChoices/hwDisabled), `'session'`(selDate·selStudent·showMini·showComment·colorMode·currentView), `'studentPdfs'`(학생별 PDF bytes/name/pageCount/isPng)
